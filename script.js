  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement("a", {
      style: {
        "--gc-color": color,
        "--gc-fill": fill,
        "--gc-fill-hover": fillHover,
        "--gc-color-hover": colorHover
      },
      href: url,
      target: "_blank",
...
class App extends React.Component {
  constructor(props) {
    ...
    _defineProperty(this, "heightAnimation", () => {
    ...
    _defineProperty(this, "shareQuote", social => {
      ...
      switch (social) {
        case "facebook":
          ...
          facebookShareUrl = window.open('https://www.facebook.com/sharer.php?s=100&p[title]=' + selectedQuote + '&p[summary]=' + selectedAuthor + '&p[url]=' + url, "", winOptions);
          // window.open("https://www.facebook.com/share.php?u=" + url + "&t=" + selectedQuote, "", winOptions);
          console.log("hey");
          break;
        case "twitter":
          window.open("https://twitter.com/intent/tweet?&text=" + selectedQuote.slice(-1) + " by " + selectedAuthor + "%0D%0A&url=" + url + "%0D%0A&hashtags=" + "codepen", "_top", winOptions);
          console.log("hey");
          break;
      }
    });
  ...
  randomColorSelection() {
    ...
    this.setState({
      hue: hue,
      bodyBg: 'hsl(' + hue + ', ' + this.state.saturation + '%, ' + this.state.lightness + '%, 1)',
      cardBg: 'hsl(' + hue + ', ' + (this.state.saturation - 15) + '%, ' + (this.state.lightness - 15) + '%, 1)',
      boxShadow: "2px 32px 32px -10px hsl(" + hue + ', ' + (this.state.saturation - 25) + '%, ' + (this.state.lightness - 40) + '%, 1)',
      boxShadowColor: 'hsl(' + hue + ', ' + (this.state.saturation - 25) + '%, ' + (this.state.lightness - 40) + '%, 1)'
    });
  }
  ...
  render() {
    ...
    const renderQuotes = filterArray.map(i => /*#__PURE__*/React.createElement("div", {
      className: "text-container",
      ref: this.textRef
    }, /*#__PURE__*/React.createElement("p", {
      id: "text"
    }, i.quote), /*#__PURE__*/React.createElement("p", {
      id: "author"
    }, i.author)));
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(GithubCorner, {
    ...
    }), renderQuotes, /*#__PURE__*/React.createElement("div", {
      ref: this.btnRef,
      class: "button-container"
    }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("button", null, /*#__PURE__*/React.createElement("a", {
      href: "javascript:void(0)",
      onClick: () => this.shareQuote("twitter"),
      id: "tweet-quote"
    }, /*#__PURE__*/React.createElement("i", {
      class: "fa-brands fa-twitter",
      style: {
        color: this.state.cardBg
      }
    }))), /*#__PURE__*/React.createElement("button", null, /*#__PURE__*/React.createElement("a", {
      href: "javascript:void(0)",
      onClick: () => this.shareQuote("facebook"),
      id: "facebook-quote"
    }, /*#__PURE__*/React.createElement("i", {
      ...
      onClick: this.randomQuoteSelection,
      id: "new-quote",
      style: {
        color: this.state.cardBg
      }
    }, "New Quote")))), /*#__PURE__*/React.createElement("h5", {
      class: "by",
      style: {
        "--color": textColor,
        "--hoverColor": textColorHover
      }
    }, "Designed and coded by\xA0", /*#__PURE__*/React.createElement("a", {
      target: "_blank",
